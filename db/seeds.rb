...
# p1 = Payer.create(name: "DANNON", points: 0, spentpoints: 0, spent: 0)
# p2 = Payer.create(name: "UNILEVER", points: 0, spentpoints: 0, spent: 0)
# p3 = Payer.create(name: "MILLER COORS", points: 0,spentpoints: 0, spent: 0)
...
# http://127.0.0.1:3000/transactions/dannon/3000/%222020-11-02T14:00:00Z